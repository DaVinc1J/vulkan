...
void app_init(_app *p_app) {
	...
	static const _billboard lights[] = {
		{ .pos = {0.0f, 1.0f, 0.0f, 0.25f}, .data = {1.0f, 1.0f, 0.0f, 100.5f}, .flags = {0, 0, 0, 0}},
	};
	...
	glm_vec4_copy((vec4){1.0f, 1.0f, 1.0f, 0.05f}, p_app->lighting.ambient);
}
